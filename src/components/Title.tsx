    ...
    <section className="flex flex-col gap-[30px]">
      ...
      <div className="flex flex-col gap-[10px]">
        <span className="text-lg leading-[1.5]">
          안녕하세요! 같이 일하고 싶은 신입 개발자 박지영입니다. “이 정도면
          됐다”에 안주하지 않고, “조금만 더 해 보면 어떨까” 하는 마음가짐으로
          개발합니다. 저는 완성이란 과정의 또 다른 이름이라고 믿습니다.
          예술가들이 작품을 계속해서 다듬어 나가듯, 더 나은 결과물에 다가가기
          위해 꾸준히 개선하고 성장하는 개발자가 되고자 합니다.
        </span>
        <span className="text-lg leading-[1.5]">
